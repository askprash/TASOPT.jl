...
@testset "Engine models" begin
    ...
    @testset "Simple engine" begin
        ...
        # constant_TSFC_engine! writes eng.mfuel directly; no sync needed.
    ...
    # (engine_state_to_pare! / design_state_to_pare! round-trip testsets removed
    #  — functions deleted in tasopt-j9l.45.14.6)
